...
#ifndef VIVEPLUGIN_DEPRECATED_HH
# define VIVEPLUGIN_DEPRECATED_HH
...
//  void foo () VIVEPLUGIN_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar VIVEPLUGIN_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a VIVEPLUGIN_DEPRECATED = 0;
//
...
#  define VIVEPLUGIN_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define VIVEPLUGIN_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define VIVEPLUGIN_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! VIVEPLUGIN_DEPRECATED_HH

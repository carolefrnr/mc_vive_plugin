...
IF(NOT EXISTS "/home/carole/src/mc_vive_plugin/build/install_manifest.txt")
  MESSAGE(FATAL_ERROR "Cannot find install manifest:\"/home/carole/src/mc_vive_plugin/build/install_manifest.txt\"")
ENDIF(NOT EXISTS "/home/carole/src/mc_vive_plugin/build/install_manifest.txt")
...
FILE(READ "/home/carole/src/mc_vive_plugin/build/install_manifest.txt" files)
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND "/usr/bin/cmake" -E remove "/home/carole/src/mc_vive_plugin/build/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
